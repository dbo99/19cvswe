...
start_date <- ymd("2019-08-23")
end_date <- ymd("2019-09-30")
...
for (i in 1:length(dates)) { 
  ...
  for (j in 1:length(params)) {
    ...
    #activate these for ~2010-2012 nohrsc data that includes these all cap words and 6-letter IDs the scraper needs to ignore
